    ...
    <>
      <AnimatePresence>
        ...
        <div className="bg-gray-100 flex flex-col items-center" >
          <nav
            className={`h-[60px] flex items-center px-4 sm:px-4 py-2.5 bg-white shadow-md max-w-sm w-full`}
          >
           <Link href="/">
  <img src={`/pksiconorange.png?w=100&h=42&q=100&upscale=true&auto=compress,format`} style={{ marginTop: '5px' }} width="30" height="36" />
  <img src={`/pksicon.png?w=100&h=42&q=100&upscale=true&auto=compress,format`} style={{position: 'absolute', marginTop: '-25px', marginLeft: '40px' }} width="30" height="36" />
</Link>
