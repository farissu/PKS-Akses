      ...
      <>
        <div className="bg-gray-100 flex flex-col items-center">
          <div className="w-full max-w-md">
            ...
            <div className="h-5 bg-zinc-400 my-2 mx-50 animate-pulse w-[85%] rounded mx-auto items-center"></div>
            <div className="h-5 bg-zinc-400 my-2 mx-50 animate-pulse w-[15%] rounded mx-auto items-center"></div>
            <div className="h-10 bg-zinc-400 my-2 mx-4 animate-pulse rounded"></div>
            <div className="h-10 bg-zinc-400 my-2 mx-4 animate-pulse rounded"></div>
            <div className="h-5 bg-zinc-400 my-2 mx-50 animate-pulse w-[25%] rounded mx-4"></div>
