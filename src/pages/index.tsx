          ...
          <div>
            <motion.div
              ...
              <div className="mx-auto min-h-screen shadow-lg max-w-sm bg-white">
                {isLoading ? (
                  <div className="max-w-sm w-full min-h-screen animate-pulse mx-auto">
  ...
  return (
    <div>
      <Head>
        ...
        <meta property="og:image" content={company.logo_perusahaan_url} />
        ...
        <meta property="twitter:image" content={company.logo_perusahaan_url} />
